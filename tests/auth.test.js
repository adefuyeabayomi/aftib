...
describe("AUTHENTICATION ENDPOINTS", () => {
  ...
  describe("POST /auth/signup", () => {
    it("should sign up a user with correct input", async () => {
      const response = await request.post("/auth/signup").send(correctUserData);
    ...
    it("should not sign up a user that already exists", async () => {
      ...
      await request.post("/auth/signup").send(existingUserData);
  ...
  describe("POST /auth/login", () => {
    it("should log in a user with correct credentials", async () => {
      ...
      await request.post("/auth/signup").send(correctUserData);
